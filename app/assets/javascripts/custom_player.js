$( document ).ready(function() {
	...
	$(document).on("click", "div.user-playlists td.user-playlist", function (event){
	     ...
	     $.ajax({
	        ...
	        data: {index : $(this).attr('id')}
		     	...
		     	$("h2#playing-artist").text($("ul#playlist a").first().attr("data-artist-name"));
		      $("h2#playing-song").text($("ul#playlist a").first().attr("data-track-name"));
